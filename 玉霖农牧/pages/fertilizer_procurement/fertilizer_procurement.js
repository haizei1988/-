...
Page({
  ...
  goodsNameValue() {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/feed_basic' + '?feed_name=' + that.data.goodsName,
      method: 'GET',
      header: {
  ...
  goodsNameNull(val = '') {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/feed_basic',
      method: 'GET',
  ...
  bingId(event) {
    ...
    this.setData({
      ...
      goodsName: event.currentTarget.dataset.id.feed_name,
      array_goods_status: true,
      hiddenLoading: true,
      specification: [...temp],
      danwei: [...temp2]
  ...
  bindKeyInput(e) {
    ...
    if (e.detail.value !== '') {
      wx.request({
        url: getApp().globalData.url + '/api/feed_basic' + '?feed_name=' + e.detail.value,
        method: 'GET',
        header: {
          'Content-Type': 'application/json',
          'X-Requested-With': 'XMLHttpRequest',
  ...
  formSubmit: function (e) {
    var that = this
    var breed_basic_id = that.data.goodsId;
    var qualification_number = e.detail.value.qualification_number
    ...
    wx.request({
      ...
      method: 'POST',
      data: {
        feed_basic_id: breed_basic_id,
        quality_standard: qualification_number,
