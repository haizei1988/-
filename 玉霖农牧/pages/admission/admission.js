...
Page({
  ...
  camera:function(){
    wx.scanCode({
      ...
      success: (res) => {
        wx.navigateTo({
          url: '/pages/out/out?src=' + res.result, //
          success: function () {
          },       //成功后的回调；
