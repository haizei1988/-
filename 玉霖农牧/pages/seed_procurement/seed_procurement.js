...
Page({
  ...
  goodsNameValue() {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/breed_basic' + '?breed_name=' + that.data.goodsName,
      method: 'GET',
      header: {
  ...
  goodsNameNull(val = '') {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/breed_basic',
      method: 'GET',
  ...
  bingId(event) {
    ...
    this.setData({
      ...
      goodsName: event.currentTarget.dataset.id.breed_name,
      array_goods_status: true,
      hiddenLoading: true,
      specification: [...temp],
      danwei: [...temp2]
  ...
  bindKeyInput(e) {
    ...
    if (e.detail.value !== '') {
      wx.request({
        url: getApp().globalData.url + '/api/breed_basic' + '?breed_name=' + e.detail.value,
        method: 'GET',
        header: {
          'Content-Type': 'application/json',
          'X-Requested-With': 'XMLHttpRequest',
