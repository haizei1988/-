...
Page({
  ...
  goodsNameValue() {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/seed_basic' + '?seed_name=' + that.data.goodsName,
      method: 'GET',
      header: {
  ...
  goodsNameNull(val = '') {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/seed_basic',
      method: 'GET',
  ...
  bindKeyInput(e) {
    ...
    if (e.detail.value !== '') {
      wx.request({
        url: getApp().globalData.url + '/api/seed_basic' + '?seed_name=' + e.detail.value,
        method: 'GET',
        header: {
          'Content-Type': 'application/json',
          'X-Requested-With': 'XMLHttpRequest',
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      ...
      data: {
        ...
        seed_production_batch: seed_production_batch,
