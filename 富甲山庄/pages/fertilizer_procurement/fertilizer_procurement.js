...
Page({
  ...
  goodsNameValue() {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/muck_basic' + '?chemical_fertilizer_name=' + that.data.goodsName,
      method: 'GET',
      header: {
  ...
  goodsNameNull(val = '') {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/muck_basic',
      method: 'GET',
  ...
  bingId(event) {
    this.setData({
      ...
      goodsName: event.currentTarget.dataset.id.chemical_fertilizer_name,
      array_goods_status: true,
      hiddenLoading: true,
    })
  },
  ...
  bindKeyInput(e) {
    ...
    if (e.detail.value !== '') {
      wx.request({
        url: getApp().globalData.url + '/api/muck_basic' + '?chemical_fertilizer_name=' + e.detail.value,
        method: 'GET',
        header: {
          'Content-Type': 'application/json',
          'X-Requested-With': 'XMLHttpRequest',
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/muck',
      method: 'GET',
      data: {
        muck_basic_id: seed_basic_id,
        pesticide_production_license: seed_production_batch,
