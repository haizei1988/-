...
Page({
  ...
  goodsNameValue() {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/plant' + '?plant_batch=' + that.data.goodsName,
      method: 'GET',
      header: {
  ...
  feederValue() {
    ...
    wx.request({
      url: getApp().globalData.url + that.data.url+ '?purchase_batch=' + that.data.feederName,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  feederNull(val = '') {
    ...
    wx.request({
      url: getApp().globalData.url + that.data.url,
      method: 'GET',
  ...
  bindKeyInput(e) {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/plant' + '?plant_batch=' + e.detail.value,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  bindKeyInput2(e) {
    ...
    console.log(e.detail.value)
    wx.request({
      url: getApp().globalData.url + that.data.url + '?purchase_batch=' + e.detail.value,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  formSubmit: function (e) {
    var that = this
    var plant_basic_batch = that.data.goodsName
    ...
    // }
    wx.request({
      url: getApp().globalData.url + '/api/plant_process',
      method: 'POST',
      data: {
        plant_basic_batch: plant_basic_batch,
