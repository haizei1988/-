...
Page({
  ...
  feederValue() {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/seed' + '?purchase_batch=' + that.data.feederName,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  feederNull(val = '') {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/seed',
      method: 'GET',
  ...
  supplierValue() {
    let that = this;
    wx.request({
      url: getApp().globalData.url + '/api/plant_area' + '?area_name=' + that.data.supplierName,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  supplierNull(val = '') {
    let that = this;
    wx.request({
      url: getApp().globalData.url + '/api/plant_area',
      method: 'GET',
      data: !val ? that.data.pageData : Object.assign(that.data.pageData, {
        page: parseInt(that.data.pageData.page) + 1
      }),
  ...
  bindKeyInput2(e) {
    ...
    console.log(e.detail.value)
    wx.request({
      url: getApp().globalData.url + '/api/seed' + '?purchase_batch=' + e.detail.value,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  bindKeyInput3(e) {
    ...
    console.log(e.detail.value)
    wx.request({
      url: getApp().globalData.url + '/api/plant_area' + '?area_name=' + e.detail.value,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  bingId3(event) {
    this.setData({
      ...
      supplierName: event.currentTarget.dataset.id.area_name,
      hiddenLoading: true,
      supplier_name: true
    })
  },
  ...
  formSubmit: function (e) {
    ...
    var seed_batch = that.data.feederName
    var plant_area_id = that.data.supplierId
    ...
    // }
    wx.request({
      url: getApp().globalData.url + '/api/plant',
      method: 'POST',
      data: {
